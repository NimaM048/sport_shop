...
from account.models import User, Otp, UserSession, Notification
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = [
        ...
        ("Personal info", {"fields": ["fullname", "birthday_date", "biography",'telegram', "github", "linkdin", 'web_site','profile_picture']}),
